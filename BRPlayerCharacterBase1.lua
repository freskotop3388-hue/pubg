...
_G.InitModMenuTab = function()
    ...
    local StackAimbot = {
        ...
        {
            Key = "ModMenu_Aimbot_Ex", UI = AliasMap.TitleSwitcher,
            Text = 999200, ExpandIndex = 0,
            GetFunc = function() return _G.LexusConfig.CustomAimbot end,
            SetFunc = function(_, v) _G.LexusConfig.CustomAimbot = v; return true end
        },
        {
            Key = "ModMenu_Aimbot_Speed", UI = AliasMap.Slider,
            Text = 999201, ExpandHandle = "ModMenu_Aimbot_Ex",
            MinValue = 1, MaxValue = 100, min = 1, max = 100,
            GetFunc = function() return _G.LexusState.CustomTextData.OuterSpeed or 10 end,
            SetFunc = function(_, v) _G.LexusState.CustomTextData.OuterSpeed = v; return true end
        },
        {
            Key = "ModMenu_Aimbot_Recoil", UI = AliasMap.Slider,
            Text = 999202, ExpandHandle = "ModMenu_Aimbot_Ex",
            MinValue = 1, MaxValue = 50, min = 1, max = 50,
            GetFunc = function() return _G.LexusState.CustomTextData.OuterRecoil or 0.1 end,
            SetFunc = function(_, v) _G.LexusState.CustomTextData.OuterRecoil = v; return true end
        },
        {
            Key = "ModMenu_AimbotClose_Ex", UI = AliasMap.TitleSwitcher,
            Text = 999203, ExpandIndex = 0,
            GetFunc = function() return _G.LexusConfig.CustomAimbotClose end,
            SetFunc = function(_, v) _G.LexusConfig.CustomAimbotClose = v; return true end
        },
        {
            Key = "ModMenu_AimbotClose_Speed", UI = AliasMap.Slider,
            Text = 999204, ExpandHandle = "ModMenu_AimbotClose_Ex",
            MinValue = 1, MaxValue = 100, min = 1, max = 100,
            GetFunc = function() return _G.LexusState.CustomTextData.InnerSpeed or 10 end,
            SetFunc = function(_, v) _G.LexusState.CustomTextData.InnerSpeed = v; return true end
        },
        {
            Key = "ModMenu_Magic_Ex", UI = AliasMap.TitleSwitcher,
            Text = 999205, ExpandIndex = 0,
            GetFunc = function() return _G.LexusConfig.CustomMagicBullet end,
            SetFunc = function(_, v) _G.LexusConfig.CustomMagicBullet = v; return true end
        },
        {
            Key = "ModMenu_Magic_Head", UI = AliasMap.Slider,
            Text = 999206, ExpandHandle = "ModMenu_Magic_Ex",
            ...
            SetFunc = function(_, v) _G.LexusState.CustomTextData.MagicHead = (v / 100.0) * 5.0; return true end
        },
        {
            Key = "ModMenu_Magic_Body", UI = AliasMap.Slider,
            Text = 999207, ExpandHandle = "ModMenu_Magic_Ex",
            MinValue = 0, MaxValue = 100, min = 0, max = 100,
            GetFunc = function() return math.floor(((_G.LexusState.CustomTextData.MagicBody or 1.0) / 5.0) * 100 + 0.5) end,
            SetFunc = function(_, v) _G.LexusState.CustomTextData.MagicBody = (v / 100.0) * 5.0; return true end
        },
        {
            Key = "ModMenu_Magic_Legs", UI = AliasMap.Slider,
            Text = 999208, ExpandHandle = "ModMenu_Magic_Ex",
            MinValue = 0, MaxValue = 100, min = 0, max = 100,
            GetFunc = function() return math.floor(((_G.LexusState.CustomTextData.MagicLegs or 1.0) / 5.0) * 100 + 0.5) end,
            SetFunc = function(_, v) _G.LexusState.CustomTextData.MagicLegs = (v / 100.0) * 5.0; return true end
        },
        {
            Key = "ModMenu_HRecoil_Ex", UI = AliasMap.TitleSwitcher,
            Text = 999209, ExpandIndex = 0,
            GetFunc = function() return _G.LexusConfig.CustomHRecoil end,
            SetFunc = function(_, v) _G.LexusConfig.CustomHRecoil = v; return true end
        },
        {
            Key = "ModMenu_HRecoil_Val", UI = AliasMap.Slider,
            Text = 999210, ExpandHandle = "ModMenu_HRecoil_Ex",
            MinValue = 0, MaxValue = 100, min = 0, max = 100,
            GetFunc = function() return math.floor((((_G.LexusState.CustomTextData.HRecoil or 0.3) - 0.3) / 4.7) * 100 + 0.5) end,
            SetFunc = function(_, v) _G.LexusState.CustomTextData.HRecoil = 0.3 + (v / 100.0) * 4.7; return true end
        },
        {
            Key = "ModMenu_VRecoil_Ex", UI = AliasMap.TitleSwitcher,
            Text = 999209, ExpandIndex = 0,
            GetFunc = function() return _G.LexusConfig.CustomVRecoil end,
            SetFunc = function(_, v) _G.LexusConfig.CustomVRecoil = v; return true end
        },
        {
            Key = "ModMenu_VRecoil_Val", UI = AliasMap.Slider,
            Text = 999211, ExpandHandle = "ModMenu_VRecoil_Ex",
            MinValue = 0, MaxValue = 100, min = 0, max = 100,
            GetFunc = function() return math.floor((((_G.LexusState.CustomTextData.VRecoil or 0.3) - 0.3) / 4.7) * 100 + 0.5) end,
            SetFunc = function(_, v) _G.LexusState.CustomTextData.VRecoil = 0.3 + (v / 100.0) * 4.7; return true end
        },
        {
            Key = "ModMenu_LessShake", UI = AliasMap.Switcher,
            Text = 999212,
            GetFunc = function() return _G.LexusConfig.LessShake end,
            SetFunc = function(_, v) _G.LexusConfig.LessShake = v; return true end
        },
        {
            Key = "ModMenu_Accuracy", UI = AliasMap.Switcher,
            Text = 999213,
            GetFunc = function() return _G.LexusConfig.Accuracy end,
            SetFunc = function(_, v) _G.LexusConfig.Accuracy = v; return true end
        },
        {
            Key = "ModMenu_Crosshair", UI = AliasMap.Switcher,
            Text = 999214,
            GetFunc = function() return _G.LexusConfig.Crosshair end,
            SetFunc = function(_, v) _G.LexusConfig.Crosshair = v; return true end
        },
        {
            Key = "ModMenu_AutoHead", UI = AliasMap.Switcher,
            Text = 999217,
            GetFunc = function() return _G.LexusConfig.AutoHead end,
            SetFunc = function(_, v) _G.LexusConfig.AutoHead = v; return true end
        },
        {
            Key = "ModMenu_GodMode", UI = AliasMap.Switcher,
            Text = 999218,
            GetFunc = function() return _G.LexusConfig.GodMode end,
            SetFunc = function(_, v) _G.LexusConfig.GodMode = v; return true end
        },
        {
...
-- ============================================================
_G.InitModMenuTab()
print("[DH VIP] 😉 1.1 بێ کێشە ! / بێ باند!")
print("[دروست کردن] @MAMDANEIL | @DH_KING_of_WAR")
print("[ئاگاداری] لە ئەکەوانت شخسی بدەی خۆت لە سەر خۆت هێچ هاک زەمان نیە!")
